...
- **sign** <font color='#7d8793'>String</font> <font color='#f19938'>Required</font>  
  - Botim Money Business signs each response using its private key.  
  - Merchants verify the signature using Botim Money Business’s public key to ensure the response is authentic and not tampered with.  
