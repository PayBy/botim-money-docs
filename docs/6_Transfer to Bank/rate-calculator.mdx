...
- **fundoutInfo** <font color = ' #7d8793'>Object</font>
  ...
  - **feeAmount** <font color = ' #7d8793'>Money</font> <font color = '#f19938'>Required</font>
    ...
    The amount of money Botim Money Business will charge in this transaction. It is not included in the `orderAmount`.
...
| 62076    | FUND_OUT_ABILITY_SUPPORTED | `networkCode` or `fundoutCurrencyCode` not enabled/supported | Contact Botim Money Business   |
