...
- **firstName** <font color='#7d8793'>String(50)</font> <font color='#f19938'>Required</font>  

  - Encrypted field. Account holder's first name.  
  - Required when `accountHolderType` is `INDIVIDUAL`  

- **lastName** <font color='#7d8793'>String(50)</font> <font color='#f19938'>Required</font>  
...
- **senderInfoRequest** <font color='#7d8793'>TransferBankCardSenderInfo</font> <font color='#f19938'>Required</font>  
  - Sender information. When `senderType` is `INDIVIDUAL`, `senderInfoRequest` is required.
