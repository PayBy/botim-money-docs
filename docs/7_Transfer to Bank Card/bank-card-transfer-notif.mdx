...
4. **Signature Verification**  
   All notification requests are signed using Botim Money's RSA private key.  
   - The signature algorithm is the same as for ordinary requests.  
   - Merchants must verify the signature using Botim Money's public key, which can be downloaded from the merchant portal.
