...
| 403   | UNAUTHORIZED                | API access not authorized                          | Contact Botim Money Business for authorization          |
| 404   | SERVICE_NOT_AVAILABLE       | API service is unavailable                         | Contact Botim Money Business support                    |
| 500   | SYSTEM_ERROR                | Internal system error                              | Contact Botim Money Business support and retry later    |
