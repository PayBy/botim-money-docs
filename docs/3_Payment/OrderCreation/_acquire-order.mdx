...
- **status** <font color='#7d8793'>Enum</font> <font color='#f19938'>Required</font>  
  - The possible values are:  
    ...
    - `AUTHORIZATION`: The pre-authorization has been successful.  
    - `VOID`: The pre-authorization has been successfully cancelled.
...
- **paySceneParams** <font color='#7d8793'>Object</font> <font color='#f19938'>Required</font>  
