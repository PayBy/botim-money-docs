...
The `getOrder` interface enables merchants to query the status of any Botim Money Business order, helping them actively retrieve order information and proceed with the appropriate business logic based on the order status.
...
- **bizContent**   <font color = ' #7d8793'>Object</font>  
	...
	- **orderNo**   <font color = ' #7d8793'>String</font>    <font color = '#f19938'>Required</font>
		- The Botim Money Business's unique identify number of the order. 
...
| 500     | SYSTEM_ERROR                 | System error                                   | Contact Botim Money Business, try again later   |
...
| 62035   | ORDER_NO_NOT_EXIST           | Botim Money Business order number does not exist              | Correct Botim Money Business order number       |
