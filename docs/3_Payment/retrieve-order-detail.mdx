...
- **channelParam** <font color='#7d8793'>ChannelParam</font> <font color='#49cc90'>Optional</font>  
  - Additional parameters specific to the payment channel.

- **paymentInfoExtend** <font color='#7d8793'>PaymentInfoExtend</font> <font color='#49cc90'>Optional</font>  
  - Extended payment information for additional details.

- **cardInfo** <font color='#7d8793'>CardInfo</font> <font color='#49cc90'>Optional</font>  
...
- **brand** <font color='#7d8793'>String</font> <font color='#49cc90'>Optional</font>  
  - Card brand name (e.g., Visa, Mastercard, etc.).

- **last4** <font color='#7d8793'>String</font> <font color='#49cc90'>Optional</font>  
  - Last 4 digits of the card number.

- **first6** <font color='#7d8793'>String</font> <font color='#49cc90'>Optional</font>  
  - First 6 digits of the card number (BIN).

- **cardType** <font color='#7d8793'>String</font> <font color='#49cc90'>Optional</font>  
  - Type of card (e.g., DEBIT, CREDIT).

- **issueCountry** <font color='#7d8793'>String</font> <font color='#49cc90'>Optional</font>  
  - Country code where the card was issued.

- **cardLevel** <font color='#7d8793'>String</font> <font color='#49cc90'>Optional</font>  
  - Card level or tier (e.g., Standard, Gold, Platinum).

- **cardToken** <font color='#7d8793'>String</font> <font color='#49cc90'>Optional</font>  
  - Tokenized representation of the card for secure storage.

- **cardTokenExpTime** <font color='#7d8793'>Date</font> <font color='#49cc90'>Optional</font>  
  - Expiration time of the card token.

- **expMonth** <font color='#7d8793'>String</font> <font color='#49cc90'>Optional</font>  
  - Card expiration month (MM format).

- **expYear** <font color='#7d8793'>String</font> <font color='#49cc90'>Optional</font>  
