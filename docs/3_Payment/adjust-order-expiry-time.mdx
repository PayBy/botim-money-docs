...
| 403   | UNAUTHORIZED          | API is not authorized                              | Contact Botim Money for authorization                            |
| 404   | SERVICE_NOT_AVAILABLE | API service is unavailable                         | Contact Botim Money support                                      |
| 500   | SYSTEM_ERROR          | System error occurred                              | Contact Botim Money support and retry later                      |
