...
| 403   | UNAUTHORIZED          | API is not authorized                              | Contact Botim Money Business for authorization                            |
| 404   | SERVICE_NOT_AVAILABLE | API service is unavailable                         | Contact Botim Money Business support                                      |
| 500   | SYSTEM_ERROR          | System error occurred                              | Contact Botim Money Business support and retry later                      |
