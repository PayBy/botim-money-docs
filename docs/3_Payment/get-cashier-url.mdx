...
- **bizContent** <font color='#7d8793'>GetCashierUrlInfoRequest</font> <font color='#f19938'>Required</font>  
  ...
  - **tokenUrl** <font color='#7d8793'>String</font> <font color='#f19938'>Required</font>  
    ...
    - Example value:  
      `https://checkout.botim.money/pay-page/main?BIZ_TYPE=202&ft=cd624549f4894d78b0d368e48bb27aae&t=1654519114067`
...
```json
{
  ...
  "bizContent": {
    "tokenUrl": "https://checkout.botim.money/pay-page/main?BIZ_TYPE=202&ft=cd624549f4894d78b0d368e48bb27aae&t=1654519114067"
  }
}
```
...
| 500   | SYSTEM_ERROR          | System error occurred           | Contact Botim Money Business and retry later |
