...
Use the Revoke Order interface when no response received from Botim Money after initiating a payment request.

If the merchant is unsure whether the transaction was successfully processed by Botim Money, they can send a revoke request.  

- If the transaction was successful, Botim Money will initiate a refund.  
...
| 62035    | ORDER_NO_NOT_EXIST                                  | Botim Money order number does not exist           | Check and correct Botim Money order number    |
| 62039    | REVOKE_FAILURE                                      | Internal error in Botim Money                     | Contact Botim Money                       |
