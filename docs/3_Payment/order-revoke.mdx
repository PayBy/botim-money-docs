...
Use the Revoke Order interface when no response received from Botim Money Business after initiating a payment request.

If the merchant is unsure whether the transaction was successfully processed by Botim Money Business, they can send a revoke request.  

- If the transaction was successful, Botim Money Business will initiate a refund.  
...
| 62035    | ORDER_NO_NOT_EXIST                                  | Botim Money Business order number does not exist           | Check and correct Botim Money Business order number    |
| 62039    | REVOKE_FAILURE                                      | Internal error in Botim Money Business                     | Contact Botim Money Business                       |
