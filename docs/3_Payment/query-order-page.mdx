...
| Order No          | orderNo         | Required | String       | 131658483622183687                   | Botim Money system order number                           |
        ...
        "items": [
            {
                ...
                "orderNo": "131658483622183687",                            // Botim Money internal order number
                ...
                "product": "Basic Payment Gateway",                         // Botim Money product type used
                "totalAmount": {
