...
| 500      | SYSTEM_ERROR                               | System error                                                              | Contact Botim Money Business and retry later         |
...
| 62035    | ORDER_NO_NOT_EXIST                         | Order with the Botim Money Business order number does not exist                          | Modify Botim Money Business order number             |
