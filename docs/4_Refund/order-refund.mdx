...
| 62035    | ORDER_NO_NOT_EXIST                         | Order with the Botim Money order number does not exist                          | Modify Botim Money order number             |
