...
- **originOrderNo** <font color='#7d8793'>String</font>  
  - The Botim Money Business's unique identification number of the payment order.  
...
- **refundSharingAmount** <font color='#7d8793'>Boolean</font>  
  ...
  - Default value: `false`  
  - If `true` and `sharingParamList` is not specified, Botim Money Business will proportionally refund from the payee, sharing account, and Botim Money Business fee account.
