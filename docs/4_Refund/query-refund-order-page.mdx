...
| Merchant ID    | Partner-Id       | Required | String(12) | 200000000888     | Unique merchant identifier assigned by Botim Money |
...
| Order No                 | orderNo               | Required | String | 911588343112002067                   | Botim Money system order number                                    |
        ...
        "items": [
            {
                ...
                "orderNo": "911588343112002067",                                  // Botim Money order number
...
| `500`   | SYSTEM_ERROR          | Internal system error                                        | Contact Botim Money and try again later |
