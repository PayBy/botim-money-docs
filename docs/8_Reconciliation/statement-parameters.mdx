...
| orderNo               | Botim Money Business order No.                         |
...
| totalComm      | Botim Money Business Pre-tax commission summary |
| totalVAT       | Botim Money Business Value-added tax summary      |
...
| VAT                   | Botim Money Business Value-added tax                         |
| VATCurrency           | Botim Money Business Value-added tax currency                     |
| paymentMethodType     | Payment method                            |
| subject               | Subject                                |
| payeeMid              | Payee Member Id                        |
| terminalId            | Terminal Id                            |
