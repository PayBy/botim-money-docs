...
| totalComm      | Botim Money Pre-tax commission summary |
| totalVAT       | Botim Money Value-added tax summary      |
...
| VAT                   | Botim Money Value-added tax                         |
| VATCurrency           | Botim Money Value-added tax currency                     |
| paymentMethodType     | Payment method                            |
| subject               | Subject                                |
| payeeMid              | Payee Member Id                        |
| terminalId            | Terminal Id                            |
