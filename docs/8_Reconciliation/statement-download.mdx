...
2. **Settlement Statement**  
   This covers all settled payments, including detailed breakdowns of transactions and associated fees. Merchants can use it to reconcile the funds received from Botim Money, understand deductions such as refunds and adjustments, and review the fees withheld for each transaction.
...
>
> 1. Orders that failed to be placed successfully on Botim Money’s side will not appear in the statements.  
> 2. Botim Money generates the previous day’s statements shortly after the merchant’s configured settlement cutoff time—typically within 10 minutes. It is recommended to download the statements at least 30 minutes after the cutoff.  
...
#### Transaction Statement Example (V1)

```
*mid:200000088724|periodNo:20210113|startTime:2021-01-12 00:00|endTime:2021-01-13 01:00|totalCount:14
...
| orderNo               | Botim Money order number                     |
...
#### Transaction Statement Example (V2)

```
*mid:200000088724|periodNo:20000008872420260702|startTime:2026-07-01 00:00|endTime:2026-07-02 00:00|totalCount:1
merchantOrderNo|orderNo|paidTime|payeeMid|merchantName|terminalId|operatorId|storeId|storeName|scheme|orderCurrency|totalAmount|transactionType|productName|paySceneCode|paymentMethodType|subject|installmentPlan|planAcceptanceID|originMerchantOrderNo|reserved|status|authCode|cardNumber|cardIssuingCountry|cardLevel|cardType|customerName|mobileNumber|emailAddress|source|agreementType|authProtocolNo|dccAmount|dccCurrency|exchangeRate|dccMarkup|dccQuoteId
90a95a3f7c3d414e8d2e37452ffbd567|131782884973278414|2026-07-01T09:49:33+0400|200000088724|StarBuck Five Star|||||MASTERCARD|AED|1.00|REFUND|Basic Payment Gateway|PAYPAGE|BANK||||M20260626174845E0F86C3A||SUCCESS||512345******0008|AE|Premium|DC|||||||||||*
```
...
| planAcceptanceID      | Installment acceptance ID                    |
| originMerchantOrderNo | Original merchant order number               |
| reserved              | Reserved field                               |
| status                | Transaction status                           |
...
#### Settlement Statement Example (V1)

```
*mid:200000088724|settlePeriodNo:20210113|startTime:2021-01-12 00:00|endTime:2021-01-13 01:00|openingAmount:AED 1.00|totalCount:33|totalCredit:AED 472.70|totalDebit:AED 333.21|totalComm:AED 14.92|totalVAT:AED 0.75|settleToBank:AED 139.49 success|stayAmount:AED 1.00
...
| totalComm      | Botim Money pre-tax commission total |
| totalVAT       | Botim Money VAT total                |
...
| paidTime              | Payment success time (DD-MM-YYYY HH24:MI:SS) |
| status                | Transaction status                           |
| comm                  | Botim Money pre-tax commission               |
| commCurrency          | Botim Money pre-tax commission currency      |
| VAT                   | Botim Money VAT                              |
| VATCurrency           | Botim Money VAT currency                     |
| paymentMethodType     | Payment method type                          |
| subject               | Transaction subject                          |
| payeeMid              | Payee member ID                              |
| terminalId            | Terminal ID                                  |
...
#### Settlement Statement Example (V2)

```
*mid:200000088724|settlePeriodNo:20000008872420260702|startTime:2026-07-01 00:00|endTime:2026-07-02 00:00|openingAmount:AED 2737.72|totalCount:1|totalCredit:AED 0.00|totalDebit:AED 1.00|totalComm:AED 0.00|totalVAT:AED 0.00|settleToBank:AED 2736.72 failure|stayAmount:AED 2736.72
merchantOrderNo|orderNo|settledTime|paidTime|payeeMid|merchantName|terminalId|operatorId|storeId|storeName|scheme|orderCurrency|totalAmount|transactionType|direction|productName|paySceneCode|paymentMethodType|subject|installmentPlan|planAcceptanceID|originMerchantOrderNo|reserved|status|settlementAmount|commCurrency|comm|VATCurrency|VAT|authCode|cardNumber|cardIssuingCountry|cardLevel|cardType|source|agreementType|authProtocolNo|dccAmount|dccCurrency|exchangeRate|dccMarkup|dccQuoteId
90a95a3f7c3d414e8d2e37452ffbd567|131782884973278414|2026-07-01T09:49:33+0400|2026-07-01T09:49:33+0400|200000088724|StarBuck Five Star|||||MASTERCARD|AED|1.00|REFUND|OUT|Basic Payment Gateway|PAYPAGE|BANK||||M20260626174845E0F86C3A||SUCCESS|1.00|AED|0.00|AED|0.00||512345******0008|AE|Premium|DC||||||||*
```
...
| ORDER_NO          | Botim Money order number  |
...
| 601   | RISK_FAIL                         | Risk control verification failed             | Adjust the business request                          |
| 62008 | EXPIREDTIME_LESS_THAN_REQUESTTIME | Expiry time is earlier than the request time | Adjust the expiry time                               |
| 62013 | STATEMENT_NOT_EXIST               | Statement does not exist                     | The merchant has no statement available for download |
