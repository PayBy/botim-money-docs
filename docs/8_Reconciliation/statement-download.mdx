...
2. **Settlement Statement**  
   This covers all settled payments, including detailed breakdowns of transactions and associated fees. Merchants can use it to reconcile the funds received from Botim Money Business, understand deductions such as refunds and adjustments, and review the fees withheld for each transaction.
...
> **<font color = '#f19938'>Note:</font>**
  ...
  1. Orders that failed to be placed successfully on Botim Money Business’s side will not appear in the statements.  
  2. Botim Money Business generates the previous day’s statements shortly after the merchant’s configured settlement cutoff time—typically within 10 minutes. It is recommended to download the statements at least 30 minutes after the cutoff.  
...
| orderNo               | Botim Money Business order number                           |
...
| totalComm      | Botim Money Business pre-tax commission total       |
| totalVAT       | Botim Money Business VAT total                      |
...
| paidTime              | Payment success time (DD-MM-YYYY HH24:MI:SS) |
| status                | Transaction status                           |
| comm                  | Botim Money Business pre-tax commission                     |
| commCurrency          | Botim Money Business pre-tax commission currency            |
| VAT                   | Botim Money Business VAT                                    |
| VATCurrency           | Botim Money Business VAT currency                           |
| paymentMethodType     | Payment method type                          |
| subject               | Transaction subject                          |
| payeeMid              | Payee member ID                              |
| terminalId            | Terminal ID                                  |
...
| ORDER_NO          | Botim Money Business order number        |
