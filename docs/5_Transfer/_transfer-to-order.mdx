...
- **product** <font color='#7d8793'>String</font> <font color='#f19938'>Required</font>  
  - The product name of the API method used in the order. Used for Botim Money Business internal classification.  
  - Maximum length: `100`
...
- **beneficiaryFullName** <font color='#7d8793'>String</font>  
  - If provided, Botim Money Business verifies it against the beneficiary's KYC info.  
