...
- **beneficiaryFullName** <font color='#7d8793'>String</font> <font color='#999999'>Optional</font>  
...
- **notifyUrl** <font color='#7d8793'>String</font> <font color='#999999'>Optional</font>  
  
  - URL to receive asynchronous notifications of order status updates.  
  - Example value: `https://www.yoursite.com`  
  - Maximum length: `200`
  
  **riskInfo** <font color='#7d8793'>String</font> <font color='#999999'>Optional</font>  
