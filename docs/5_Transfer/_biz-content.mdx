...
- **beneficiaryIdentityType** <font color='#7d8793'>String</font> <font color='#f19938'>Required</font>  
  - The fund can be transferred to the beneficiary through mobile phone number or Botim Money Business member ID.  
  - Possible values:  
...
- **beneficiaryFullName** <font color='#7d8793'>String</font>  
  - If provided, Botim Money Business will verify it against the beneficiary's KYC information.  
