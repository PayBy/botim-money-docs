...
This interface provides merchants with the ability to transfer funds to the Botim Money user account (Account registered with mobile phone number in Botim Money or Botim APP).
