...
This interface provides merchants with the ability to transfer funds to the Botim Money Business user account (Account registered with mobile phone number in Botim Money Business or Botim APP).
